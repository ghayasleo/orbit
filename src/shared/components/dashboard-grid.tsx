...
import type { Layout, DashboardLayouts } from "../context/dashboard-context";
import { HeroBanner } from "./widgets/hero-banner";
import { HabitStreaksWidget } from "./widgets/habit-streaks-widget";
import { PriorityTasksWidget } from "./widgets/priority-tasks-widget";
import { BudgetPlannerWidget } from "./widgets/budget-planner-widget";
import { ActiveGoalsWidget } from "./widgets/active-goals-widget";
import { RecentExpensesWidget } from "./widgets/recent-expenses-widget";
import { UpcomingDueWidget } from "./widgets/upcoming-due-widget";
import { RemindersWidget } from "./widgets/reminders-widget";
import { LoansOverviewWidget } from "./widgets/loans-overview-widget";
