...
type ContainerVariantKeys = "hidden" | "visible" | "exit";

type ContainerVariants = {
  [K in ContainerVariantKeys]?: TargetAndTransition;
};
...
const presetVariants: Record<
  PresetType,
  { container: ContainerVariants; item: Variants }
> = {
  blur: {
...
export function TextEffect({
  ...
  const delayedContainerVariants: ContainerVariants = {
    ...containerVariants,
    visible: {
