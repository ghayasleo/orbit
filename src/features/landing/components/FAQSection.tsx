    ...
    <section id="faq" className="bg-bg-base py-16 md:py-28 overflow-hidden">
      <div className="mx-auto max-w-[1160px] px-6">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
          ...
          {/* Left Column — Intro */}
          <motion.div 
            className="w-full lg:w-[340px] shrink-0 lg:sticky lg:top-[120px]"
                ...
                >
                  ...
                  <AccordionContent className="text-[15px] text-text-secondary leading-[1.7] pb-6 pr-6">
                    ...
                    {faq.a.split(/`([^`]+)`/).map((part, i) => (
                       i % 2 === 1 ? <code key={i} className="bg-bg-subtle border border-border-subtle px-1.5 py-0.5 rounded text-[13px] text-text-primary whitespace-nowrap">{part}</code> : part
                    ))}
                  </AccordionContent>
                </AccordionItem>
              ))}
