...
export function SocialProofBar() {
  ...
  return (
    <section className="bg-bg-subtle py-10 border-b border-border-subtle overflow-hidden">
      <div className="mx-auto max-w-[1160px] px-6">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          
          {/* Label */}
          <p className="text-sm text-text-muted font-normal whitespace-nowrap shrink-0">
            Trusted and used by people from
          </p>

          {/* Scrolling Marquee Container */}
          <div className="relative flex overflow-hidden w-full [mask-image:linear-gradient(to_right,transparent,black_20%,black_80%,transparent)]">
            <motion.div
